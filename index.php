...
<body class="bg-white">
    ...
    <div class="relative">
        ...
        <input type="search" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 border rounded-2xl dark:bg-gray-700 dark:border-black-600 dark:placeholder-gray-400 dark:text-white dark:focus:outline-none" placeholder="Search Properties" required>
    ...
    <input type="submit" name="logout" value="logout" class="text-white bg-aber-700 hover:bg-amber-800 font-medium rounded-lg text-sm px-4 py-2 dark:bg-amber-600 dark:hover:bg-amber-700 dark:focus:ring-amber-800">
    </form> 
</div>
</div>
<hr class="">
